      ...
      <div className="mx-auto flex max-w-[1600px] flex-col gap-8 px-6 py-10 md:flex-row md:justify-between">
        <div className="max-w-sm">
          ...
          <p className="mt-4 text-sm text-slate-600">
            Turn your internal documents into searchable, auditable answers —
            with secure access controls and end-to-end traceability.
          </p>
        ...
        <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-slate-600">
              ...
              <li>
                <Link to="/workspace" className="hover:text-slate-900">
                  Workspace
                </Link>
              </li>
              <li>
